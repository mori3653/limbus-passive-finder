...
const KEYWORD_DEFS = {
  ...
  "지령[단말기] Ⅲ": "동명이의 키워드. (검지 수행자:【쪽지】 파우스트) E.G.O 각성 스킬 또는 개화 E.G.O::대행 상태에서 지령 표식이 새겨진 스킬 3이 적중해야 완수되는 지령. (검지 대행자 - 개화 E.G.O::대행 돈키호테) 대행 [헤르메스]를 얻고 그 수치가 9가 될 때까지 반복 수행해야 하는 지령. 두 버전 모두 해금 - II 단계에서 얻을 수 있음.",
