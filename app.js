...
const IDENTITY_SKILL_DETAIL = {
  ...
  "이상|LCE E.G.O::초롱": {skills:[{name:null,power:"4",coin:"+3",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 파열 1 부여",2:"파괴 불가 코인 [적중시] 파열 1 부여"}},{name:null,power:"8",coin:"+6",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 파열 횟수 2 증가"}},{name:null,power:"16",coin:"-5",coinCount:3,coinEffects:{1:"[적중시] 파열 횟수 3 증가 [적중시] 다음 턴에 속박 2 부여",2:"[적중시] 파열 1 부여",3:"[적중시] 파열 1 부여"}}],defense:{name:null,power:"10",coin:"+5",coinCount:1,coinEffects:{1:"[적중시] 파열 횟수 2 증가"}}},
  ...
  "이상|거미집 검지 아비": {skills:[{name:"얼어붙은 피를 삼백삼십 휘감아",power:"3",coin:"+4",coinCount:2,coinEffects:{2:"[적중시] 호흡 2 얻음 [파괴되지 않고 적중시] 침잠 2 부여"}},{name:null,power:"4",coin:"+4",coinCount:3,coinEffects:{2:"[적중시] 침잠 3 부여",3:"[적중시] 자신의 호흡 횟수 2 증가 [파괴되지 않고 적중시] 침잠 횟수 1 증가"}},{name:null,power:"4",coin:"+3",coinCount:4,coinEffects:{2:"[적중시] 호흡 3 얻음",3:"[적중시] 침잠 3 부여",4:"해금 단계 1당 피해량 +20% (최대 60%) [크리티컬 적중 시] 자신의 호흡 횟수 1 증가 [파괴되지 않고 적중시] 침잠 횟수 3 증가"}}],defense:{name:"예측할 수 없는 변덕으로",power:"4",coin:"+10",coinCount:1,coinEffects:{}}},
  ...
  "파우스트|흑수 - 묘 필두": {skills:[{name:"순보",power:"3",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 파열 1 부여",2:"[적중시] 파열 횟수 1 증가 [적중시] 자신의 속도가 10 이상이면, 코인 1회 재사용 (스킬 당 1회)"}},{name:null,power:"4",coin:"+6",coinCount:2,coinEffects:{1:"[적중시] 파열 횟수 1 증가",2:"[적중시] 파열 1 부여 대상에게 주살【신속】 또는 주살【파】 가 있으면, 피해량 +50%"}},{name:null,power:"5",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 파열 횟수 1 증가 [적중시] 주살【신속】 부여",2:"[적중시] 파열 1 부여",3:"자신의 속도가 10 이상이면, 피해량 +30% [적중시] 파열 3 부여 [적중시] 자신의 속도가 10 이상이면, 코인 1회 재사용 (스킬 당 1회) [재사용 적중시] 주살【신속】 부여"}}],defense:{name:null,power:"5",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 파열 1 부여",2:"[적중시] 파열 1 부여"}}},
  ...
  "료슈|로보토미 E.G.O::잔향 · 외로움": {skills:[{name:null,power:"4",coin:"+4",coinCount:2,coinEffects:{1:"탄환 - 고독 1 소모 [적중시] 침잠 횟수 2 증가",2:"탄환 - 고독 1 소모 [적중시] 진동 3 부여"}},{name:"공허에 피어나는 향기",power:"4",coin:"+4",coinCount:3,coinEffects:{1:"탄환 - 고독 1 소모 [적중시] 침잠 횟수 3 증가",2:"[적중시] 잔향 3 부여 [적중시] 진동 횟수 2 증가",3:"[적중시] 잔향 3 부여 [적중시] 진동 횟수 2 증가"}},{name:"만개",power:"5",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 잔향 1 부여 [적중시] 침잠 횟수 3 증가",2:"[적중시] 잔향 1 부여 [적중시] 침잠 4 부여",3:"[적중시] 잔향 1 부여 [적중시] 진동 2 부여 [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소 [적중시] 대상의 침잠 만큼 우울 피해"}}],defense:{name:null,power:"4",coin:"+10",coinCount:1,coinEffects:{}}},
  "료슈|거미집의 검": {skills:[{name:"삼연 [三連]",power:"3",coin:"+3",coinCount:3,coinEffects:{1:"[적중시] 호흡 1 얻음 [크리티컬 적중 시] 출혈 횟수 2 증가",2:"[적중시] 호흡 2 얻음 [크리티컬 적중 시] 화상 횟수 1 증가",3:"[적중시] 호흡 2 얻음 [적중시] 검흔 [잔상] 2 부여 [적중시] 자신의 얽힘 만큼 검흔 [잔상] 부여 (최대 4) [크리티컬 적중 시] 출혈 2 부여 [크리티컬 적중 시] 이 코인 최종 피해량의 ( 얽힘 × 2)%만큼 참격 피해"}},{name:null,power:"4",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 호흡 2 얻음 [크리티컬 적중 시] 출혈 1 부여",2:"[적중시] 화상 2 부여 [크리티컬 적중 시] 출혈 1 부여",3:"[적중시] 화상 2 부여 [크리티컬 적중 시] 출혈 2 부여 [크리티컬 적중 시] 이 코인 최종 피해량의 ( 얽힘 × 3)%만큼 참격 피해"}},{name:"공간참 [空間斬]",power:"10",coin:"+12",coinCount:1,coinEffects:{1:"크리티컬 피해량 +50% [적중시] 출혈 3 부여 [적중시] 화상 3 부여 [크리티컬 적중 시] 대상의 화상 발동. 대상의 화상 횟수 1 감소 [크리티컬 적중 시] 대상의 출혈 발동. 대상의 출혈 횟수 1 감소 [크리티컬 적중 시] 이 코인 최종 피해량의 ( 얽힘 × 4)%만큼 참격 피해"}}],defense:{name:"잔상보 [殘像步]",power:"4",coin:"+10",coinCount:1,coinEffects:{}}},
  ...
  "뫼르소|동부 엄지 카포 IIII": {skills:[{name:"이연참-폭 [爆]",power:"4",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 진동 1 부여",2:"호표탄 1 소모 [적중시] 진동 2 부여 [적중시] 화상 2 부여"}},{name:"삼연격-폭 [爆]",power:"4",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 진동 1 부여",2:"호표탄 1 소모 [적중시] 진동 2 부여 [적중시] 화상 2 부여",3:"호표탄 1 소모 [적중시] 진동 횟수 2 증가 [적중시] 화상 횟수 2 증가 [적중시] 대상의 진동 횟수가 3 이상이면, 진동 폭발 . 대상의 진동 횟수 1 감소"}},{name:"쾌도난마 [快刀亂麻]",power:"5",coin:"+4",coinCount:3,coinEffects:{1:"호표탄 1 소모 [적중시] 진동 3 부여 [적중시] 화상 3 부여",2:"호표탄 1 소모 [적중시] 진동 횟수 3 증가 [적중시] 화상 횟수 3 증가",3:"호표탄 1 소모 이 코인 효과로 호표탄 을 소모하였다면, 피해량 +50% [적중시] 진동 - 작열 로 진폭 변환 [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소 - 호표탄 소모 시, 효과 2회 추가 발동"}}],defense:{name:null,power:"5",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 진동 1 부여 (턴당 2회)",2:"[적중시] 진동 횟수 1 증가 (턴당 2회)"}}},
  "뫼르소|라만차랜드 왕자": {skills:[{name:"행진 지휘",power:"2",coin:"+3",coinCount:3,coinEffects:{1:"[적중시] 파열 1 부여",2:"[적중시] 출혈 횟수 1 증가",3:"[적중시] 출혈 2 부여"}},{name:"재건의 의무",power:"4",coin:"+6",coinCount:2,coinEffects:{1:"[적중시] 출혈 횟수 2 증가 [적중시] 파열 횟수 1 증가",3:"[적중시] 출혈 2 부여 [적중시] 파열 2 부여 [적중시] 다음 턴에 색욕 취약 1 부여"}},{name:null,power:"4",coin:"+3",coinCount:3,coinEffects:{1:"[적중시] 출혈 횟수 1 증가 [적중시] 파열 횟수 1 증가",2:"[적중시] 출혈 횟수 1 증가",3:"[적중시] 출혈 2 부여 [적중시] 파열 1 부여",4:"파괴 불가 코인 [적중시] 출혈 2 부여 [적중시] 라만차 퍼레이드 1 부여 [파괴되지 않고 적중시] 다음 턴에 라만차 퍼레이드 1 부여"}}],defense:{name:"피 굳히기",power:"5",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 출혈 1 부여",2:"[적중시] 출혈 1 부여"}}},
  ...
  "이스마엘|서부 츠바이 협회 3과": {skills:[{name:"츠바이 기사단 대검술",power:"3",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 진동 횟수 1 증가 [적중시] 다음 턴에 방어 레벨 증가 2를 얻음",2:"[적중시] 진동 횟수 1 증가 [적중시] 다음 턴에 방어 레벨 증가 2를 얻음"}},{name:null,power:"4",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 진동 4 부여",2:"[적중시] 다음 턴에 방어 레벨 증가 4를 얻음",3:"[적중시] (자신의 진동 횟수 / 2)만큼 진동 부여 (최대 4) [적중시] 자신의 방어 레벨 증가 가 8 이상이면, 대상에게 공격 위력 감소 1 부여"}},{name:"수호",power:"5",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 진동 2 부여",2:"[적중시] 진동 2 부여",3:"[적중시] 자신의 진동 횟수를 전부 소모하여, 소모한 값만큼 진동 부여 (최대 20) - (초과한 진동 × 5)%만큼 피해량이 증가 (최대 50%) [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소 [적중시] 방어 태세 면, 진동 폭발 . 대상의 진동 횟수 1 감소"}}],defense:{name:"당신의 방패",power:"3",coin:"+12",coinCount:0,coinEffects:{1:"파괴 불가 코인"}}},
  ...
  "로쟈|R사 제 4무리 순록팀": {skills:[{name:null,power:"3",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 침잠 1 부여 [적중시] 자신의 충전 횟수 3 증가",2:"[적중시] 침잠 1 부여 [적중시] 자신의 충전 횟수 2 증가"}},{name:null,power:"4",coin:"+6",coinCount:2,coinEffects:{1:"[적중시] 침잠 2 부여, 침잠 횟수 2 증가 [적중시] 자신의 충전 횟수 6 증가",2:"[적중시] 자신의 충전 횟수가 8 미만이면, 침잠 5 얻고 자신의 충전 횟수 4 증가 [적중시] 자신의 충전 횟수가 8 이상이면, 4 소모하여 다음 턴에 타격 취약 1 부여 (턴당 1회)"}},{name:null,power:"4",coin:"+3",coinCount:4,coinEffects:{1:"[적중시] 침잠 횟수 3 증가 [적중시] 피해량의 10%만큼 흐트러짐 손상을 입힘 - 자신의 충전 이 3 이상이면, 대신 피해량의 20%만큼 흐트러짐 손상을 입힘",2:"[적중시] 침잠 1 부여 [적중시] 피해량의 10%만큼 흐트러짐 손상을 입힘",3:"[적중시] 침잠 1 부여 [적중시] 피해량의 10%만큼 흐트러짐 손상을 입힘",4:"[적중시] 침잠 1 부여 [적중시] 피해량의 5%만큼 흐트러짐 손상을 입힘"}}],defense:{name:null,power:"10",coin:"+5",coinCount:1,coinEffects:{}}},
...
const IDENTITY_PASSIVE = {
  ...
  "이상|약지 점묘파 스튜던트": {name:"과제평가",sin:"색욕",count:"4",effect:"- 적중시 대상에게 출혈 이 4 이상 있으면 정신력 2 회복 - 대상이 보유한 부정적인 효과 1개당 정신력 1 추가 회복. (최대 3) - 이 효과로 정신력 회복 시 자신의 정신력이 최대면 다음 턴에 공격 레벨 증가 2 얻음 (턴 당 패시브 최대 발동 횟수 : 4회)"},
  "이상|로보토미 E.G.O::엄숙한 애도": {name:"쏘아라.쏘으리로다.",sin:"우울",count:"3",effect:"공격 종료 시 자신의 스킬에 의해 대상이 사망했으면, 재장전 산나비·죽은나비 를 얻으면, 다음 턴에 신속 2 얻음 (턴 당 1회)"},
  ...
  "이상|N사 E.G.O::흉탄": {name:"흉탄",sin:"오만",count:"6",effect:"전투 중 자신이 아군을 사망시켰다면 다음 턴 동안 흉탄 을 얻음 (자신의 E.G.O 침식 및 아군 공격 포함) 자신의 E.G.O 흉탄을 사용하여, 찢어진 추억 이 소모되면, 턴 종료 시 소모한 만큼 다음 턴에 찢어진 추억 을 얻음"},
  "이상|흑수 - 오 필두": {name:"흑풍마각 [黑風馬脚]",sin:"탐식",count:"5",effect:"아래의 조건 만족 시 적진 주파 1 얻음 - 공격 시작 시 대상보다 속도가 2 이상 높을 때 - 자신의 스킬로 진동 폭발 효과 2회 발동시 (E.G.O 스킬 포함) - 각력【오】 를 보유 중인 상태로 합 승리 시 ※ 적진 주파 는 턴 당 최대 3까지 얻을 수 있으며, '흑풍마각월참' 스킬로는 얻을 수 없음 자신에게 보호막이 있을 때, 방어 레벨이 (보호막 수치 / 10)만큼 증가 (최대 5, 소수점 버림)"},
  "이상|거미집 검지 아비": {name:"모조된 삶",sin:"탐식",count:"1",effect:"자신의 지령의 가호 1당 지령 표식 스킬 피해량 +2% (최대 16%) - 지령의 가호 가 9면, 대신 기본 스킬 피해량 +20% 기본 공격 스킬의 파괴 불가 코인 적중 시, 대행 [헤르메스] 1 얻음 - 공격 종료 시, 남은 파괴 불가 코인 수만큼 대행 [헤르메스] 얻음 - 'Furioso-Replica' 공격 종료 시, (남은 파괴 불가 코인 수/2)만큼 다음 턴에 대행 [헤르메스] 얻음 (소수점 버림) 턴 종료 시 이번 턴에 대행 [헤르메스] 가 증가하여 9가 되었을 때, 다음 턴 시작 시 조작 슬롯에 스킬 3이 없으면, 기본 스킬 하나를 스킬 3으로 변경 (가장 왼쪽 슬롯의 아래 스킬 우선)"},
  "이상|LCE E.G.O::차원찢개": {name:"속도와좌표와속도",sin:"질투",count:"4",effect:"자신의 속도가 대상보다 빠르면, (대상과의 속도 차이 × 자신의 충전 위력)%만큼 피해량이 증가 (최대 20%) 턴 종료 시, (자신의 충전 위력 / 2)만큼 다음 턴에 신속 얻음 (최대 2, 소수점 버림)"},
  ...
  "파우스트|흑수 - 묘 필두": {name:"흑수화 [묘] / 묘 필두",sin:"탐식",count:"5",effect:"자신의 속도가 대상보다 빠르면, 속도 차이 1 당 가하는 피해량 +2% (최대 10%) 전투 중 아군이 주살 효과를 발동시킬 때마다, 천구성도 1 얻음 (턴 당 최대 5회) - 자신이 발동시켰으면, 천구성도 추가로 1 얻음 원호 방어 효과 발동 시, 천구성도 5 얻음"},
  "파우스트|동부 시 협회 3과": {name:"시노유미",sin:"색욕",count:"3",effect:"자신의 화살 - 시 가 4면 기본 공격 스킬 효과로 호흡 위력을 얻을 때, 호흡 횟수 1 증가 (전투당 3회, 화살 - 시 가 3이 될 때 발동 횟수 초기화) 목표 조준 이 2 이상일 때 '섬궁'을 사용했으면, 다음 턴에 참격 피해량 증가 2 얻음"},
  "파우스트|검지 수행자:【쪽지】": {name:"수행자의 검",sin:"나태",count:"1",effect:"자신의 지령의 가호 1당 지령 표식 스킬 피해량 +2% (최대 16%) - 지령의 가호 가 9면, 대신 기본 스킬 피해량 +20% 지령 대상 이 있는 대상에게 기본 스킬 적중 시, 호흡 1 얻고 침잠 1 부여 (턴당 1회) - 지령의 가호 3당, 턴당 발동 가능한 횟수 +1 (최대 2) 지령의 가호 가 9면, 기본 스킬의 침잠 위력 부여값 +1. 호흡 위력 획득값 +1"},
  "파우스트|거미집 약지 제자": {name:"크리틱으로부터의 영감",sin:"색욕",count:"4",effect:"신체가 울리는 선율 의 속도, 합 위력, 피해량이 증가하는 효과가 2배로 적용됨 공격 적중 시 해당 공격 스킬로 부정적인 효과를 부여했으면, 공격 종료시 자신의 정신력 4 회복 (턴당 2회) - 이 효과로 정신력 회복 시 자신의 정신력이 최대면, 다음 턴에 참격 피해량 증가 1 얻음 (턴당 1회)"},
  "파우스트|새벽 사무소 해결사": {name:"포이어팔터 [스티그마 공방]",sin:"분노",count:"3",effect:"자신에게 전투 감각 이 있을 때 전투 시작 시 (수치x3)만큼 불꽃나비의 관 얻음 자신 이외의 새벽 사무소 소속 인격이 다음 조건 만족 시, 새벽 사무소 해결사 파우스트가 '연계' 사용 (인격별 턴당 1회) - 기본 스킬 공격 종료 시 적중한 적이 흐트러졌을 때, 대상에게 사용 (해당 스킬 공격 시작 전 이미 흐트러짐 상태였으면 발동하지 않음) - 새벽 사무소 대표 그레고르의 '새벽을 가르는 검', '새벽녘' 또는 새벽 사무소 해결사 싱클레어의 '낙인', '타오르는 일격' 공격 종료 시, 적중한 적에게 사용 (흐트러진 대상 우선) 새벽 사무소 해결사 싱클레어가 전장에 있으면, 새벽 사무소 해결사 파우스트가 사용하는 기본 스킬의 재사용 코인 적중 시 대상 적의 화상 위력만큼 분노 피해를 추가로 입힘 (최대 10, 턴당 최대 20) - 화상 이 발동한 것으로 취급 캐리어 또는 악기 케이스와 같이 생긴 이 무기를 쓰는 이유는 명확하다. 첫 번째는 일상에 녹아들기 위함이다. 전투에서 활용하기 어렵고 복잡한 유형의 무기는 오히려 그 비효율성 때문에 무기로 인식되지 않을 확률이 높다. 두 번째는 캐리어의 모양, 그 자체로 인해 생기는 수납력이다. 그렇기에 무언가를 담는 형태의 무기는 제뱌찌 협회에서 적극적으로 사용한다. 다만, 이러한 장점과 별개로 공방 장비를 쓰는 이들 사이에서 평가는 좋지 않다. 이 무기를 다루기 위해 투자한 시간을 다른 무기에 쏟았다면, 더 강해졌을 것이라거나, 겉멋이나 든 요즘 해결사들이 쓰는 장비라는 말을 종종 들을 수 있다. 이러한 까다로운 장비를 들고 있는 사람을 만났을 때, 그 사람이 고등급 해결사, 혹은 직책 높은 조직원이라는 것은… 역설적이게도 다른 의미를 가진다. 그렇기에 공방에서 이 장비의 명칭은 캐리어가 아닌 관, 코핀으로 불리고 있다. 그리고 관에는 으레 나비가 따라붙는다."},
  ...
  "돈키호테|라만차랜드 실장": {name:"혈갑",sin:"색욕",count:"4",effect:"자신의 공격 종료 시 적이 사망했다면, 대상의 최대 체력 10%만큼 혈찬 생성 (최대 100, 집중 전투인 경우 부위로 판정) 턴 종료 시 잃은 체력 15% 당 다음 턴에 피해량 증가 1 얻음 (최대 3) 전투 중 아군이 출혈 피해로 사망하려 할 때, 해당 턴 동안 출혈 피해로는 사망하지 않음 (전투 당 인격 1명당 1회 발동)"},
  ...
  "돈키호테|로보토미 E.G.O::사랑과 증오의 이름으로": {name:"사랑의 마법소녀 / 증오의 여왕",sin:"질투",count:"4",effect:"사랑/증오 당, 피해량 +2% (최대 10%) 전투 시작 시, 매지컬 아르카나 1 얻음"},
  "돈키호테|흑수 - 미": {name:"발파각쇄",sin:"탐식",count:"3",effect:"대상의 정신력이 0 미만이면, 피해량이 (-대상의 정신력/3)%만큼 증가 (최대 15%, 소수점 버림) 대상의 파열 과 침잠 의 합 2당 피해량 +1% (최대 15%) - 정신력이 없는 대상이면, 이 효과와 최댓값이 2배로 증가 자신에게 발각[發角] 이 있으면, 적을 공격할 때 기본 스킬 마지막 코인의 피해량 +15% - 수비 스킬을 장착한 스킬 슬롯 공격 시, 대신 마지막 코인의 피해량 +30% - 합 가능 수비 스킬과 합 진행 시, 추가로 합 위력 +3"},
  "돈키호테|검지 대행자 - 개화 E.G.O::대행": {name:"역시 마법의 삐삐님은 본인이 원하는 걸 알아주시는 군!",sin:"색욕",count:"1",effect:"자신의 지령의 가호 1당 지령 표식 스킬 피해량 +2% (최대 16%) - 지령의 가호 가 9면, 대신 기본 스킬 피해량 +20% 지령 대상 이 있는 대상에게 기본 스킬 적중 시, 정신력 3 회복 (스킬당 1회, 턴당 2회) - 해금 단계만큼 정신력 추가 회복"},
  ...
  "료슈|로보토미 E.G.O::적안 · 참회": {name:"거미대가리 / 해골바가지",sin:"색욕",count:"3",effect:"적안 을 얻는 코인을 사용하여 적에게 적중 시 - 피해량이 ( 적안 / 2)%만큼 증가 - 대상의 속도가 자신보다 3 이상 낮으면, 피해량이 ( 적안 / 2)%만큼 추가로 증가 - 대상에게 출혈 이 있으면, 적안 1 얻음 (턴 당 최대 3) 참회 를 얻는 코인을 사용하여 적에게 적중 시 - 피해량이 ( 참회 / 2)%만큼 증가 - 대상의 정신력이 자신보다 낮으면, 피해량이 ( 참회 / 2)%만큼 추가로 증가 (정신력이 없는 대상일 경우, 0으로 계산) - 자신의 정신력이 20 이상이면 참회 1 얻음 (턴 당 최대 3) 적에게 피격 시, 참회 1 얻음 (최대 3)"},
  "료슈|흑수 - 묘": {name:"흑수화 [묘]",sin:"탐식",count:"3",effect:"자신에게 각력【묘】 가 있으면 가하는 피해량 +5% 대상에게 주살【신속】 이 있으면 가하는 피해량 +5%"},
  "료슈|N사 E.G.O::경멸, 경외": {name:"놓쳤던 @#$의 손",sin:"색욕",count:"2",effect:"적에게 공격 적중 시, 시선 2 부여 (적 당 턴 당 최대 1회) - 자신에게 경멸의 시선 이 있으면, 시선 1 추가 부여 적에게 피격 시, 공격자에게 시선 1 부여 (스킬 당 최대 1회, 턴 당 최대 3회) - 자신에게 시선의 경멸 이 있으면, 공격자의 마지막 코인 적중 시 공격자에게 해당 코인으로 받은 피해량의 20%만큼 나태 속성 피해를 입힘 (스킬 당 최대 20, 턴 당 최대 60) 기본 스킬로 적의 시선 또는 경멸 을 소모했다면, 다음 턴에 (소모한 적의 시선 / 2 + 소모한 적의 경멸 X 3)만큼 경멸의 시선 획득 (턴 당 최대 6. 소숫점 버림)"},
  "료슈|홍원 방랑무사": {name:"협객",sin:"오만",count:"3",effect:"적이 아군을 공격하여 해당 아군이 사망했거나 체력이 25% 미만이면, 해당 공격 종료시 홍원 방랑무사 료슈가 '가척아원'으로 해당 적 일방 공격 (전투 당 1회) - 홍원 군주 홍루는 횟수 제한을 초과하여 이 효과 1회 추가 발동 가능 '군.가.곁.좋' 패시브로 '어이, 물러서라' 발동 시, 해당 스킬 크리티컬 피해량 +30%. 자신을 제외한 정신력이 가장 낮은 아군 1명의 정신력 2 ~ 4 회복 (턴 당 1회. 정신력이 -40 이하인 아군 제외)"},
  "료슈|로보토미 E.G.O::잔향 · 외로움": {name:"시들지 않는 꽃",sin:"나태",count:"1",effect:"적이 침잠 피해를 받으면 꽃잎 1 얻음 적에게 부여되는 잔향 만큼 꽃잎 얻음 진동 폭발 발생 시, 꽃잎 2 얻음 자신의 공격 스킬 종료시, 자신의 꽃잎 이 30 이상이면 잔향 이 가장 높은 대상에게 '황홀한 종말' 발동 흐트러진 대상의 잔향 에 비례하여 가하는 피해량 +(대상의 잔향 )% 이번 턴에 자신의 체력을 최대 체력의 10% 이상 잃으면, 최대 체력의 3%, 정신력 10 회복 (턴당 1회)"},
  "료슈|거미집의 검": {name:"잔상 반향",sin:"오만",count:"5",effect:"자신의 20를 초과하는 호흡 위력 1당 자신의 기본 공격 스킬 크리티컬 피해량 +1% (최대 10%) 자신의 기본 공격 스킬이 크리티컬 적중시, 검흔 [잔상] 1 부여 아군을 대상으로 한 공격 스킬로 삼천대세계 E.G.O의 패시브 발동 가능"},
  ...
  "뫼르소|검계 우두머리": {name:"본국검술",sin:"오만",count:"3",effect:"이번 전투에서 체력이 0이 되는 피해를 받았을 때, 해당 피해를 받지 않고, 해당 턴 동안 체력이 1로 유지됨 (전투 당 1회) 자신의 스킬, 코인 효과로 호흡 위력, 횟수를 얻을 때, 자신을 제외한 호흡 이 없거나, 가장 낮은 검계 조직원 2명의 호흡 위력, 횟수 1 증가 - 전투에 참여한 검계 조직원이 6명 이상이면, 대신 2 증가 전투 시작 시 자신을 제외한 검계 조직원에게 본국검술 부여"},
  ...
  "뫼르소|동부 엄지 카포 IIII": {name:"천퇴성도 [天退星刀]",sin:"나태",count:"3",effect:"호표탄 보유 시, - 1 이상이면 '쾌도난마'의 모든 코인이 파괴 불가 코인 으로 변경 - 호표탄 을 소모하는 스킬 코인의 위력 +1, 피해량 +10% (소모 가능한 만큼만 적용) 맹호표탄 보유 시, - 1 이상이면 기본 공격 스킬의 모든 코인이 파괴 불가 코인 으로 변경 - 0이면 기본 공격 스킬의 특수 탄환을 소모할 수 있는 코인이 파괴 불가 코인 으로 변경 - 맹호표탄 을 소모하는 스킬 코인의 위력 +2, 피해량 +30%, 해당 코인으로 적중 시 부여하는 화상 위력과 화상 횟수 부여값 +2 (소모 가능한 만큼만 적용)"},
  "뫼르소|라만차랜드 왕자": {name:"&#39;피를 두르고, 가면을 쓰고, 피가 명하는 대로&#39;",sin:"색욕",count:"3",effect:"전투 시작 시 자신에게 경혈 갑주 가 있으면, 수치에 따라 아래 효과를 얻음 - 3 ~ : 공격 레벨 증가 2, 방어 레벨 증가 2 - 4 ~ : 다음 턴에 신속 2 전투 시작 시 자신에게 연기 집중 이 있으면, 적에게 공격 적중 시 라만차 퍼레이드 1 부여 (턴당 2회, E.G.O 스킬 포함) 출혈 을 보유한 적에게 공격 적중 시 자신의 체력이 30% 미만이면, 자신의 최대 체력의 30%만큼 체력 회복 (전투당 1회, 소수점 버림)"},
  "뫼르소|로보토미 E.G.O::호넷【변조】": {name:"포자 확산",sin:"분노",count:"3",effect:"포자 를 보유한 적 처치 시, 아래 효과 적용 - 다음 턴 동안 부여하는 포자 수치 2배가 됨 - 기본 공격 스킬로 처치 시 (해당 스킬에서 소모하는 포자탄 / 2)만큼 포자탄 획득 (소수점 올림, 스킬당 1회)"},
  "뫼르소|약지 야수파 스튜던트": {name:"차오르는 영감",sin:"색욕",count:"4",effect:"자신에게 야수파 - 마스크 드 시앵 이 있으면, 찢긴 색채 [루주] 부여량 +1 자신이 찢긴 색채 [루주] 를 4 부여할 때마다, 정신력 5 회복 (턴당 2회) - 이 효과로 정신력 회복 시 자신의 정신력이 최대치이면, 다음 턴에 타격 피해량 증가 1 얻음 (턴당 1회)"},
  ...
  "홍루|마침표 사무소 대표": {name:"전술적 사격 지원",sin:"오만",count:"5",effect:"마침표 사무소 해결사 히스클리프가 후방 지원 배치 상태거나, 대기 인원으로 편성되어 있다면 마침표 사무소 대표 홍루 인격의 스킬 2, 스킬 3이 강화됨 전투 시작시 자신의 호흡 위력이 20 이상이면, 호흡 횟수 1 얻음"},
  ...
  "홍루|홍원 군주": {name:"더러운 피마저 받아들이고, 누군가의 피를 묻혀가며 뜻을 이룬다.",sin:"탐식",count:"5",effect:"전투 시작시 자신이 수비 스킬을 장착하지 않고 일방공격 당할 예정이면, 원호 방어 수치가 가장 낮은 무작위 흑수 아군 (최대 공명 수 / 3)명에게 호위 1 부여. (최대 2명, 인격 당 1회. 원호 방어 를 획득하는 스킬 보유 인격 제외) 이번 전투에서 체력이 0이 되는 피해를 받았을 때, 해당 피해를 받지 않고 해당 턴 동안 체력이 1로 유지되며, 오혈 1 얻음 (전투 당 1회) 자신의 오혈 1 당 스킬 피해량 +3% E.G.O 스킬 '오혈읍루 - 종' 발동 시, 공격 종료시 사망 효과가 발동하지 않고 최대 체력의 60% 회복. 다음 턴부터 매 턴 시작시마다 피해량 증가 1 얻음 (전투 당 1회)"},
  "홍루|거미집 약지 아비": {name:"마에스트로의 크리틱",sin:"색욕",count:"4",effect:"거미집 약지 제자 파우스트가 스킬 3(E.G.O 스킬 제외)을 사용하기 전 거미집 약지 아비 홍루가 '우린 피와 살을 사랑한답니다'를 파우스트에게 사용함 (턴당 1회) 공격 적중 시 해당 공격 스킬로 부정적인 효과를 부여했으면, 공격 종료시 자신의 정신력 4 회복 (턴당 3회) - 이 효과로 정신력 회복 시 자신의 정신력이 최대면, 다음 턴에 참격 피해량 증가 1 얻음 (턴당 1회)"},
  "홍루|S사 추노꾼": {name:"추쇄건[推刷巾]",sin:"오만",count:"3",effect:"자신의 속도가 대상보다 빠르면, (대상과의 속도 차이 × 2)%만큼 피해량이 증가 (최대 10%) - 대상이 포박 [홍루] 상태면, 피해량이 증가하는 효과가 2배로 적용됨 전투 시작시 이번 턴에 참격 속성이고, 오만 속성인 스킬을 장착한 아군당 피해량 +5% (최대 30%)"},
  "홍루|동부 섕크 협회 3과": {name:"초염옥구",sin:"분노",count:"2",effect:"합 승리 시 대상에게 점혈 이 있으면, 점혈 - 홍루 1 부여 (턴당 1회) 턴 종료 시 자신의 호흡 위력 3당, 다음 턴에 신속 1 얻음 (최대 2) 크리티컬 피해량 +(대상의 화상 위력)% (최대 15%) - 대상의 점혈 - 홍루 1당, 최댓값 +5% 증가"},
  ...
  "히스클리프|와일드헌트": {name:"마왕의 부름",sin:"질투",count:"5",effect:"- 대상의 침잠 1 당 피해량 +1% (최대 15%) - 전투 중 아군 1명이 사망에 이르는 피해를 받았을 때, 관 2를 소모하여 와일드헌트 부여 (턴 당 2회) - 다음 턴에 와일드헌트 를 부여한 대상에게 피해량 증가 2 부여 - 워더링하이츠, 에드가 가문 소속이면, 다음 턴에 공격 위력 증가 1 추가 부여"},
  "히스클리프|마침표 사무소 해결사": {name:"정밀 조준",sin:"오만",count:"2",effect:"턴 종료 시 자신의 호흡 10 당 신속 1 얻음 (최대 2) 전투 시작 시 자신이 (E.G.O 스킬 포함) 공격 스킬을 사용할 예정이 아니면, 호흡 위력이 가장 낮은 아군 1명에게 호흡 3 부여 턴 종료 시 이번 턴에 자신이 (E.G.O 스킬 포함, 타겟 포착 제외) 공격 스킬을 사용하지 않았다면, 다음 턴에 호흡 10, 관통 위력 증가 1 얻음"},
  "히스클리프|흑운회 와카슈": {name:"흑운도",sin:"색욕",count:"3",effect:"자신을 포함해 전투에 참여한 아군 흑운회 소속 인격이 2명 이상이면 흑운도 1 얻음 (최대 1) 이번 턴에 수비 스킬을 사용했거나, 공격 시작 전에 최대 체력인 적에게 입히는 피해량 +10% 적이 자신을 제외한 아군을 공격하여 피해를 입혔으면, 공격자를 스킬 1로 공격 (턴 당 1회) 적이 자신을 제외한 아군을 처치했거나, 공격 종료 후 공격당한 아군의 체력이 25% 미만이면, 대신 공격자를 '뒷골목의 규칙'으로 일방 공격함 (아군 캐릭터 당 1회, 턴 당 2회. 해당 효과로 발동된 스킬은 공격 스킬로 간주함)"},
  "히스클리프|W사 4등급 정리 요원 - CCA": {name:"컨제스쳔 클리닝 아머",sin:"질투",count:"5",effect:"전투 시작시 자신의 체력이 50% 미만이면, ( 충전 위력 × 5)만큼 보호막 얻음 (최대 25) 피격 직전, (자신의 충전 위력)만큼 보호막 얻음 (최대 5, 턴 당 최대 3회) 자신의 스킬로 충전 횟수 최대치를 초과하여 충전 횟수를 얻으면, 최대치를 초과한 충전 횟수 1 당 해당 스킬 피해량 +3% (최대 15%)"},
  "히스클리프|흑수 - 유 필두": {name:"맞부딪치는 혈투",sin:"탐식",count:"5",effect:"전투 시작시 자신의 잃은 체력 20%당 공격 레벨 증가, 방어 레벨 증가 1 얻음 (최대 3) 아래의 조건 만족 시 혈투본능 얻음 (턴당 최대 10) - 합 시작 시 3 얻음 - 기본 공격 스킬 적중시 또는 자신이 화상 피해를 받을 때 1 얻음 자신의 현재 체력이 50% 미만이면, 추가 1 얻음 - 적 처치 시 5 얻음"},
  "히스클리프|중지 작은 형님": {name:"작은 형님",sin:"질투",count:"4",effect:"전투 시작시, 질투 공명 당 원한 문신 1 얻음 (최대 7) 적이 자신을 포함한 중지 소속 아군을 공격했으면, 해당 스킬 공격 종료 시 공격자를 '발길질'로 일방 공격함 (턴당 1회)"},
  "히스클리프|거미집 엄지 제자": {name:"팔레르모 검술",sin:"색욕",count:"2",effect:"자신의 완성되어가는 교본 과 메인 타겟 적의 결투 고조 수치 합에 따라 다음 효과 전부 얻음 - 수치 1당, 기본 스킬로 가하는 피해량 +3% (최대 15%) - 1 : 합 위력 +1 - 2 : 기본 스킬의 기본 위력 +1 - 3 : 기본 스킬의 공격 적중 시, 다음 턴에 힘줄 절단 1 부여 - 4 : 기본 스킬의 최종 위력 +1 - 5 : 기본 스킬의 피해량 +15% 자신의 완성되어가는 교본 과 자신을 공격하는 적의 결투 고조 수치 합 1당, 받는 피해량 -3% (최대 15%)"},
  ...
  "이스마엘|피쿼드호 선장": {name:"피쿼드호의 선장",sin:"오만",count:"3",effect:"자신의 공격 종료 시에 대상이 사망했으면, - 호흡 4, 호흡 횟수를 2 얻고, 다음 턴에 과열된 가스 작살 상태가 됨 - 자신을 제외한 정신력이 가장 낮은 아군 2명의 정신력 7 회복, 호흡 4 부여 - 대상이 피쿼드호 선원이면, 정신력 5 추가 회복, 턴 당 1회 다음 턴에 관통 위력 증가 1 부여"},
  ...
  "이스마엘|흑운회 부조장": {name:"몰려드는 검은 구름",sin:"색욕",count:"3",effect:"전투 시작시 자신을 포함해 전투에 참여한 아군 흑운회 소속 인격이 2명 이상이면, 흑운도 1 얻음 전투 시작시 조작 패널에서 자신의 양 옆의 흑운회 소속 인격에게 검은 구름 1 부여 - 색욕 공명이 4 이상이면, 자신을 제외한 모든 흑운회 소속 아군에게 검은 구름 1 부여"},
  "이스마엘|가주 후보": {name:"파흡자환 [破吸自桓]",sin:"탐식",count:"5",effect:"자신의 공격 스킬로 대상 처치 시 대상의 파열 만큼 호흡 을 얻음 (적 1명당 최대 3, 턴 당 최대 1회) - 위 효과로 호흡 을 3까지 얻었다면, 대상의 파열 횟수만큼 자신의 호흡 횟수 증가 (적 1명당 최대 2, 턴 당 최대 1회) 합 진행 시 합을 진행하는 적보다 공격 레벨이 높으면, 합 위력 +1 합 진행 시 합을 진행하는 적보다 공격 레벨이 높으면, 기본 공격 스킬로 부여하는 파열 위력 또는 파열 횟수 +1 (턴 당 2회 발동)"},
  "이스마엘|정사무소 대표": {name:"낱장치기",sin:"나태",count:"2",effect:"뒷면 적중 시 정신력 5 회복 (턴당 1회) 사기 저하 또는 패닉 상태인 적에게 가하는 피해량 +10%"},
  ...
  "이스마엘|LCD 현장추리팀": {name:"림버스 컴퍼니 제작 특수 의체 시제품 mk5 - 도깨비팔",sin:"오만",count:"3",effect:"전투 시작 시 도깨비팔 을 얻으며, 자신을 제외한 검계 소속 아군 인격의 정신력을 (오만 공명 수)만큼 회복 전투 시작 시 자신을 제외한 현재 체력이 최대 체력의 50% 미만인 아군이 있으면, 원호 방어 1 얻음 (턴당 1회) 스킬 종료시 자신의 호흡 위력 3당, 묵 공방 - 예[銳] 2식 발도 / 추력:도깨비불 1 얻음 (최대 5, 턴당 2회)"},
  ...
  "로쟈|북부 제뱌찌 협회 3과": {name:"신속 배달",sin:"탐식",count:"4",effect:"턴 시작 시 속도가 6 이상이거나 신속 을 보유하였다면, 자신의 최대 체력의 ( 딜리버리 캐리어 - 로쟈 )%만큼 보호막을 얻음 (최대 20%) 퇴각 시, 다음 턴에 아군 둘에게 합 위력 증가 1 부여 (대기 해제된 인격에게 우선으로 부여되며, 그 다음으로는 편성 순서가 빠른 순으로 적용) - 자신이 보유한 딜리버리 캐리어 - 로쟈 15 당 유지 턴 수 1 증가 (최대 2턴 증가)"},
  "로쟈|라만차랜드 공주": {name:"경혈의 가시",sin:"색욕",count:"3",effect:"자신을 제외한 아군이 출혈 피해를 받거나 혈찬 을 소모할 때마다, 피어나는 가시 1 얻음 (턴 당 최대 5회) 자신이 기본 스킬로 가한 피해량의 20%만큼 자신의 체력 회복 (스킬당 최대 10) - 자신이 최대 체력이면, 초과하는 회복량만큼 현재 체력 비율이 가장 낮은 아군 1명의 체력 회복"},
  "로쟈|흑수 - 사": {name:"흑수화 [사]",sin:"탐식",count:"5",effect:"자신에게 사완 이 있으면, 가하는 피해량 +5% 대상에게 주살【독】 이 있으면, 가하는 피해량 +5%"},
  "로쟈|로보토미 E.G.O::눈물로 벼려낸 검": {name:"정의의 마법소녀 / 절망의 기사",sin:"우울",count:"3",effect:"가호 상태일 때, - 공격으로 받는 피해량이 (정신력 / 2)%만큼 감소 (최대 20%) - 전투 시작 시 지키는 검 이 3 이상이면, 보호 1 얻음 - 전투 시작 시 지키는 검 이 5일 경우 효과가 강화되어, 보호 2, 합 위력 증가 1 얻음 절망 상태일 때, - 기본 스킬로 가하는 피해량이 (-정신력 / 2)%만큼 증가 (최대 20%) - 전투 시작 시 꿰뚫는 검 이 3 이상이면, 피해량 증가 1 얻음 - 전투 시작 시 꿰뚫는 검 이 5일 경우 효과가 강화되어, 피해량 증가 2, 위력 증가 1 얻음"},
  ...
  "로쟈|약지 야수파 도슨트": {name:"여기서는 조금 더 거칠게…!",sin:"색욕",count:"2",effect:"찢긴 색채 [루주] , 찢긴 색채 [블뢰] , 과감한 터치 부여량 +1"},
  "로쟈|거미집 엄지 아비": {name:"팔레르모 스파다",sin:"분노",count:"3",effect:"보유한 가속탄 이 1 이상이면, 스킬 3의 코인 위력 +1, 피해량 +25% 메인 타겟의 화상 2당, 기본 스킬로 가하는 피해량 +1% (최대 15%) - 메인 타겟에게 보호막이 있으면, 대신 기본 스킬로 가하는 피해량 +3% (최대 45%)"},
  ...
  "싱클레어|새벽 사무소 해결사": {name:"스티그마 공방 무기 / 격정",sin:"분노",count:"5",effect:"- 자신이 스킬로 부여하는 화상 위력과 횟수 +1 (턴 당 최대 6회 발동) - 자신이 불안정 E.G.O 상태이고, 정신력이 0 이상이면, (자신의 정신력 / 20)만큼 코인 위력이 증가함. 자신의 정신력이 45면, 대신 코인 위력 +3"},
  "싱클레어|북부 제뱌찌 협회 3과": {name:"잠시만 부탁드려요...!",sin:"탐식",count:"4",effect:"턴 시작 시 속도가 6 이상이거나 신속 을 보유하였다면, 자신의 최대 체력의 ( 딜리버리 캐리어 - 싱클레어 )%만큼 보호막을 얻음 (최대 20%) 퇴각 시, 다음 턴에 아군 둘에게 합 위력 증가 1 부여 (대기 해제된 인격에게 우선으로 부여되며, 그 다음으로는 편성 순서가 빠른 순으로 적용) - 자신이 보유한 딜리버리 캐리어 - 싱클레어 15 당 유지 턴 수 1 증가 (최대 2턴 증가)"},
  ...
  "싱클레어|동부 엄지 솔다토 II": {name:"탄환 상납",sin:"오만",count:"3",effect:"탄환 을 쓰는 인격 중 편성 순서가 가장 빠른 아군 1명의 공격이 종료되었을 때, 해당 인격의 현재 보유 탄환 이 절반 미만이면(소수점 올림), 해당 인격이 소모한 수만큼 자신의 작열 추진탄 을 소모하고, 작열 추진탄 을 소모한 만큼 해당 인격이 사용하는 탄환 을 보급함. (최대 소모 값 : 5개) (전투당 1회) - 탄환 을 보급받는 인격이 자신보다 계급이 높은 엄지 소속 인격이면, 해당 인격이 사용하는 탄환 을 1개 더 보급함. - 위력, 횟수가 분리된 탄환 은 위력, 횟수를 무작위로 보급함 - 만약 위력 또는 횟수가 최댓값인 경우, 최댓값이 아닌 쪽의 탄환 으로 보급함"},
  "싱클레어|흑수 - 유": {name:"싸움에 취해보죠",sin:"분노",count:"3",effect:"파열 이 7 이상 부여된 대상에게 적중 시 (최대 공명 수) × 15% 확률로 화상 1 부여 (턴 당 4회) 전투 종료시 자신에게 화상 이 있으면, 다음 턴 시작시 혈염 [血炎] 1, 분노 피해량 증가 1, 탐식 피해량 증가 1 얻음 전투 시작 시 자신의 잃은 체력 20% 당 공격 레벨 증가 , 방어 레벨 증가 1 얻음 (최대 3)"},
  "싱클레어|거미집 소지 제자": {name:"정검[整劍]",sin:"오만",count:"2",effect:"전투 시작 시, (오만 공명 수 / 2) + 1만큼 호흡 얻음 (최대 4, 소수점 버림) 전투 종료 시 자신의 호흡 이 20 이상이면, 자신의 호흡 횟수 1 증가"},
  ...
  "오티스|약지 점묘파 스튜던트": {name:"여러 점",sin:"색욕",count:"4",effect:"전투 시작 시 부정적인 효과를 가장 적게 보유한 적 2명에게 화상 , 출혈 , 진동 , 파열 , 침잠 중 무작위 1개 효과 2 부여"},
  ...
  "오티스|라만차랜드 이발사": {name:"그 옷이 아니야!!!",sin:"색욕",count:"3",effect:"재봉 대상 과 합을 할 때, 합 위력 +1 적중시 자신의 누적 소모 혈찬 10 당 피해량 +1.5% (최대 30%) 적중시 대상의 출혈 당 피해량 +0.5% (최대 10%)"},
  ...
  "그레고르|라만차랜드 신부": {name:"자멸적 헌신",sin:"색욕",count:"5",effect:"턴 종료 시, 가장 정신력이 낮은 아군의 정신력을 (10 - 자신의 닳아버린 마음 )만큼 회복시킴 (자신 또는 패닉, E.G.O 침식 상태인 아군 제외) 이번 전투에서 체력이 0이 되는 피해를 받았을 때, 해당 피해를 받지 않고, 해당 턴 동안 체력이 1로 유지됨 (전투 당 1회)"},
  "그레고르|불주먹 사무소 생존자": {name:"나만 살아남아버렸어...",sin:"분노",count:"3",effect:"자신이 이번 전투에서 소모한 12구산 연료 , 과열 연료 당 피해량 +0.2% (최대 40%) - 메인 타겟이 &lt;혈귀&gt;, &lt;피주머니&gt;거나, 대상의 화상 과 화상 횟수의 합이 30 이상이면, 대신 피해량 +0.3% (최대 60%) 12구산 연료 , 과열 연료 가 1 이상일 때, 화상 이 부여된 적을 흐트러짐 상태로 만들거나 처치하면 화상 이 없거나 화상 횟수가 가장 낮은 무작위 적 2명의 화상 횟수 2 증가 (턴 당 1회) - 집중 전투인 경우 부위에 부여"},
  ...
  return `
    <article class="card">
      ...
      <div class="card-body">
        ...
        <button type="button" class="skillset-passive-btn" data-sinner="${d.sinner.replace(/"/g,"&quot;")}" data-identity="${d.identity.replace(/"/g,"&quot;")}">전투 패시브</button>
      </div>
    </article>`;
}
...
function passiveTooltipHTML(sinner, identity){
  const p = IDENTITY_PASSIVE[`${sinner}|${identity}`];
