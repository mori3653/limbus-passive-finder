...
const KEYWORD_DEFS = {
  ...
  "지령": "특정 조건에 따라 '지령[단말기]' 등급이 주어지는 진행형 자원. 등급이 오를수록 달성 가능한 지령의 가호 최댓값이 증가.",
  ...
  "핏빛 가위날": "수치가 일정치를 넘으면 II·III 단계로 승급하며 단계별로 강화되는 자원. 기본 단계에서는 효과가 없다가 II 단계부터는 수치에 비례해 공격 레벨 증가와 방어 레벨 감소를, III 단계부터는 방어 레벨 감소 없이 공격 레벨 증가만 얻음.",
  ...
  "피로 물든 손": "수치가 일정치를 넘으면 II·III 단계로 승급하며 단계별로 강화되는 자원. II 단계부터 전투 시작 시 수치에 비례한 공격 레벨 증가를 얻고, III 단계에서는 기본 스킬 적중마다 파열과 출혈도 추가로 부여함.",
  "피어나는 가시": "피격 시 공격자에게 출혈을 되돌려주며 수치에 비례해 방어 레벨을 얻는 자원. 라만차랜드 공주 로쟈 전용으로 수치가 최대치에 달하면 단계가 승급되어 기본 스킬의 출혈·파열 부여량이 단계별로 강화됨.",
  ...
  "경혈": "수치가 일정치를 넘으면 II·III 단계로 승급하며 단계별로 강화되는 자원. 기본적으로 수치에 비례해 속도가 늘고, II 단계부터는 공격 레벨도, III 단계부터는 방어 레벨까지 추가로 증가함.",
  ...
  "지령[쪽지] I": "지령 표식이 새겨진 스킬을 사용하거나 적중시키면 발동하는 지령. 지령의 가호가 낮은 구간(0~2)일 때 부여됨.",
  "지령[쪽지] II": "지령 표식이 새겨진 스킬이 적중해야 발동하는 지령. 지령의 가호가 중간 구간(3~5)일 때 부여됨.",
  "지령[쪽지] III": "E.G.O 각성 스킬 또는 지령 표식이 새겨진 스킬 3이 적중해야 발동하는 지령. 지령의 가호가 높은 구간(6~8)일 때 부여됨.",
  "지령[쪽지] IV": "모든 적을 처치해야 완수되는 최종 지령. 지령의 가호가 최대(9)일 때 부여됨.",
  "지령[단말기] III": "동명이의 키워드. (검지 수행자:【쪽지】 파우스트) E.G.O 각성 스킬 또는 개화 E.G.O::대행 상태에서 지령 표식이 새겨진 스킬 3이 적중해야 완수되는 지령. (검지 대행자 - 개화 E.G.O::대행 돈키호테) 대행 [헤르메스]를 얻고 그 수치가 9가 될 때까지 반복 수행해야 하는 지령. 두 버전 모두 해금 - II 단계에서 얻을 수 있음.",
