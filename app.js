...
const IDENTITY_SPECIAL_SKILLS = {
  ...
  "파우스트|동부 시 협회 3과": [{name:"섬궁【閃弓】",sin:"색욕",power:"4",coin:"+4",coinCount:1,coinEffects:{1:"[적중시] 박힌 화살 1 부여, 부여 성공시 화살 - 시 1 감소 [적 처치 시] 다음 턴에 절명 1 얻음 [크리티컬 적 처치 시] 자신의 호흡 횟수 4 증가"},refNote:"저격 자세 참조",attachTo:"passive"},{name:"회피",sin:"색욕",power:"4",coin:"+10",coinCount:1,coinEffects:{},refNote:"수비 스킬 참조",attachTo:"defense"}],
  "파우스트|거미집 약지 제자": [{name:"도축 - 갈비뼈",sin:"탐식",power:"3",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 출혈 횟수 1 증가",2:"[적중시] 다음 턴에 방어 레벨 감소 2 부여 (턴당 1회) [적중시] 다음 턴에 방어 레벨 증가 2 얻음 (턴당 1회)"},refNote:"패시브 참조",attachTo:"passive"},{name:"파시아 식사 시간이네요",sin:"질투",power:"4",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 출혈 횟수 2 증가",2:"[적중시] 다음 턴에 속박 1 부여 (턴당 1회) [적중시] 다음 턴에 신속 1 얻음 (턴당 1회)",3:"[적중시] 자신의 생체 재료 횟수 4 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"억압당한 육체의 해방",sin:"색욕",power:"4",coin:"+3",coinCount:4,coinEffects:{1:"[적중시] 출혈 4 부여",2:"[적중시] 다음 턴에 속박 1 부여 (턴당 1회) [적중시] 다음 턴에 신속 1 얻음 (턴당 1회)",3:"[적중시] 다음 턴에 피해량 감소 1 부여 (턴당 1회) [적중시] 다음 턴에 참격 피해량 증가 1 얻음 (턴당 1회)",4:"대상의 부정적인 효과 1개당, 피해량 +5% (최대 30%) [적중시] 출혈 횟수 1 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"시작된 전시회",sin:"색욕",power:"4",coin:"+10",coinCount:1,coinEffects:{},refNote:"패시브 참조",attachTo:"passive"},{name:"반달리즘은 사절입니다",sin:"색욕",power:"4",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 출혈 횟수 1 증가",2:"[적중시] 출혈 2 부여"},refNote:"원호 방어 참조",attachTo:"defense"}],
  "파우스트|새벽 사무소 해결사": [{name:"연계",sin:"탐식",power:"4",coin:"+3",coinCount:2,coinEffects:{1:"[적중시] 진동 횟수 1 증가 (턴당 2회)",2:"[적중시] 화상 횟수 1 증가 (턴당 2회)"},refNote:"패시브 참조",attachTo:"passive"},{name:"사출-정오",sin:"분노",power:"5",coin:"+4",coinCount:0,coinEffects:{1:"파괴 불가 코인",2:"파괴 불가 코인",3:"파괴 불가 코인 이 코인 재사용 (최대 2회) 전투 감각 이 있으면, 피해량 +(대상의 화상 위력/2)% (최대 20%) [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소 (스킬당 3회)"},refNote:"스킬 3 참조",attachTo:"skill3"},{name:"정오의 해체",sin:"분노",power:"5",coin:"+4",coinCount:0,coinEffects:{1:"파괴 불가 코인",2:"파괴 불가 코인",3:"파괴 불가 코인 이 코인 재사용 (최대 2회) 전투 감각 이 있으면, 피해량 +(대상의 화상 위력)% (최대 20%) [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소 (스킬당 3회)"},refNote:"수비 스킬 참조",attachTo:"defense"}],
  "돈키호테|라만차랜드 실장": [{name:"아류 산초 경혈 6식 - 채찍",sin:"나태",power:"4",coin:"+3",coinCount:1,coinEffects:{2:"파괴 불가 코인 [적중시] 출혈 2 부여",3:"파괴 불가 코인 [적중시] 출혈 2 부여 [적중시] 대상의 출혈 을 1회 발동시킴. 대상의 출혈 횟수 1 감소"},refNote:"패시브 참조",attachTo:"passive"},{name:"아류 산초 경혈 8식 - 갈라지도록",sin:"분노",power:"4",coin:"+3",coinCount:2,coinEffects:{1:"[적중시] 출혈 2 부여",2:"[적중시] 출혈 2 부여",3:"파괴 불가 코인 대상의 출혈 당 피해량 +2.5% (최대 25%) 공용 누적 소모 혈찬 100 당 피해량 +15% (최대 75%)"},refNote:"패시브 참조",attachTo:"passive"},{name:"산초류 경혈 오의 - 라 샹그레",sin:"색욕",power:"5",coin:"+5",coinCount:0,coinEffects:{1:"파괴 불가 코인",2:"파괴 불가 코인",3:"파괴 불가 코인",4:"파괴 불가 코인 [적중시] 출혈 8 부여, 출혈 횟수 4 증가 [공격 종료시] 대상이 사망했으면. 모든 적에게 출혈 5 부여, 출혈 횟수 1 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"아류 산초 경혈 15식 - 피날레 준비",sin:"색욕",power:"6",coin:"+5",coinCount:1,coinEffects:{2:"파괴 불가 코인 [적중시] 출혈 횟수 3 증가"},refNote:"패시브 참조",attachTo:"passive"}],
  "돈키호테|로보토미 E.G.O::사랑과 증오의 이름으로": [{name:"악당은... 어디있어....?",sin:"분노",power:"12",coin:"-4",coinCount:2,coinEffects:{2:"[적중시] 자신의 사랑/증오 횟수 3 증가 [적중시] 침잠 3 부여"},refNote:"패시브 참조",attachTo:"passive"},{name:null,sin:"질투",power:"15",coin:"-6",coinCount:2,coinEffects:{1:"[적중시] 자신의 사랑/증오 횟수 3 증가",2:"[적중시] 침잠 2 부여 [적중시] 다음 턴에 메인 타겟에게 악당 표식 부여"},refNote:"패시브 참조",attachTo:"passive"},{name:"리버스드 비트 / 리버스드 아르카나 슬레이브",sin:"질투",power:"20",coin:"-6",coinCount:0,coinEffects:{1:"파괴 불가 코인",2:"파괴 불가 코인 [파괴되지 않고 적중시] 침잠 2 부여",3:"파괴 불가 코인 [파괴되지 않고 적중시] 침잠 2 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  "돈키호테|검지 대행자 - 개화 E.G.O::대행": [{name:"이 손으로 대신…",sin:"색욕",power:"4",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 침잠 2 부여",2:"[적중시] 침잠 횟수 1 증가 [크리티컬 적중 시] 자신의 호흡 횟수 1 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"대행: 새기기",sin:"오만",power:"5",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 침잠 2 부여",2:"[적중시] 침잠 2 부여",3:"[적중시] 자신의 호흡 횟수 1 증가 [크리티컬 적중 시] 침잠 횟수 1 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"대행: 말살",sin:"우울",power:"5",coin:"+3",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 침잠 1 부여",2:"파괴 불가 코인 [적중시] 침잠 1 부여",3:"파괴 불가 코인 [적중시] 침잠 1 부여",4:"파괴 불가 코인 해금 단계 1당, 이 코인의 위력 +1, 피해량 +40% (각각 최대 3, 최대 120%) [적중시] 침잠 1 부여 [크리티컬 적중 시] 침잠 횟수 2 증가"},refNote:"패시브 참조",attachTo:"passive"},{name:"강제 해금",sin:"우울",power:"4",coin:"+3",coinCount:3,coinEffects:{2:"[적중시] 침잠 1 부여",3:"[적중시] 침잠 1 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  ...
  "료슈|N사 E.G.O::경멸, 경외": [{name:"경멸 밑으로 쏟아지는 경외의 시선",sin:"색욕",power:"14",coin:"+14",coinCount:0,coinEffects:{1:"파괴 불가 코인 대상에게 경멸 이 있으면, 피해량 +235% [적중시] 진동 4 부여, 진동 횟수 2 증가 [적중시] 출혈 4 부여, 출혈 횟수 2 증가 [파괴되지 않고 적중시] 진동 - 과다출혈 로 진폭 변환 [적중시] 진동 폭발 . 대상의 진동 횟수 1 감소"},refNote:"스킬 3 참조",attachTo:"skill3"},{name:"쏘아내겠소 / 언제든지",sin:"오만",power:"4",coin:"+7",coinCount:0,coinEffects:{1:"파괴 불가 코인 이 코인에는 메인 타겟만 피해를 입음",2:"파괴 불가 코인 이 코인에는 서브 타겟만 피해를 입음 - 첫 번째 코인 피해가 크리티컬이 아니고, N사 E.G.O::경멸, 경외 료슈가 생존했다면, 서브 타겟 중 무작위 1명이 피해를 입음 자신의 찢어진 추억 당 피해량 +40% (최대 280%) - 호흡 위력당, 크리티컬 피해량 +5% (최대 50%) - 자신의 찢어진 추억당 , 크리티컬 피해량 +10% (최대 70%) - 메인 타겟의 잃은 체력 비율만큼 피해량 증가 (최대 100%) [적중시] 출혈 5 부여, 출혈 횟수 2 증가"},refNote:"패시브 참조",attachTo:"passive"}],
  "료슈|로보토미 E.G.O::잔향 · 외로움": [{name:"멈추지 않는 이야기",sin:"나태",power:"9",coin:"+1",coinCount:3,coinEffects:{1:"[적중시] 침잠 횟수 1 증가 [적중시] 다음 턴에 고독 2 부여",2:"[적중시] 진동 2 부여 [적중시] 다음 턴에 고독 2 부여",3:"[적중시] 진동 2 부여 [적중시] 다음 턴에 고독 2 부여"},refNote:"패시브 참조",attachTo:"passive"},{name:"황홀한 종말",sin:"우울",power:"12",coin:"+7",coinCount:1,coinEffects:{},refNote:"패시브 참조",attachTo:"passive"}],
  "료슈|거미집의 검": [{name:"천살 [天殺]",sin:"분노",power:"16",coin:"+2",coinCount:1,coinEffects:{1:"[적중시] 검흔 [잔상] 20 부여 [적중시] 대상이 거미집 소속 아군 인격이면, 대상 최대 체력의 120%만큼 고정 피해"},refNote:"잔상보 참조",attachTo:"passive"},{name:"필연쇄 [必然殺]",sin:"오만",power:"10",coin:"+4",coinCount:1,coinEffects:{1:"크리티컬 피해량 +30% [적중시] 검흔 [잔상] 2 부여 [적중시] 자신의 얽힘 만큼 검흔 [잔상] 부여 (최대 4) [적중시] 대상의 화상 발동. 대상의 화상 횟수 1 감소 [크리티컬 적중 시] 참격 취약 1 부여"},refNote:"패시브 참조",attachTo:"passive"},{name:"공간참 - 잔 [空間斬 - 殘]",sin:"분노",power:"16",coin:"+1",coinCount:2,coinEffects:{1:"[적중시] 자신의 호흡 횟수 1 증가 [적중시] 화상 1 부여 [적중시] 출혈 1 부여",2:"크리티컬 피해량 +30% [적중시] 대상의 검흔 [잔상] 을 모두 소모하여, 이 코인의 최종 피해량의 (소모값/10)%만큼 참격 피해 [크리티컬 적중 시] 이 코인의 최종 피해량의 ( 얽힘 × 4)%만큼 참격 피해 [크리티컬 적중 시] 대상의 화상 발동. 대상의 화상 횟수 1 감소 [크리티컬 적중 시] 대상의 출혈 발동. 대상의 출혈 횟수 1 감소"},refNote:"패시브 참조",attachTo:"passive"},{name:"공간참 - 연 [空間斬 - 緣]",sin:"분노",power:"14",coin:"+3",coinCount:2,coinEffects:{1:"[적중시] 화상 5 부여 [적중시] 출혈 2 부여",2:"[크리티컬 적중 시] 대상의 화상 발동. 대상의 화상 횟수 1 감소"},refNote:"패시브 참조",attachTo:"passive"}],
  "뫼르소|검계 우두머리": [{name:"골단",sin:"오만",power:"4",coin:"+4",coinCount:4,coinEffects:{4:"[적중시] 출혈 3 부여 [적중시] 다음 턴에 마비 5 부여"},refNote:"스킬 3 참조",attachTo:"skill3"}],
  ...
  "히스클리프|마침표 사무소 해결사": [{name:"로직 아틀리에제 고속분쇄탄",sin:"오만",power:"15",coin:"+18",coinCount:1,coinEffects:{1:"탄환 - 로직 아틀리에 1 소모 크리티컬 피해량 +130% 크리티컬 피해량 +(대상의 관통 내성 × 50)% [크리티컬 적중 시] 자신의 호흡 위력이 30을 초과하면, 30을 초과하는 호흡 위력을 최대 10까지 소모하여, 피해량 +(소모한 호흡 위력 × 10)%"},refNote:"스킬 3 참조",attachTo:"skill3"},{name:"엄폐",sin:"오만",power:"2",coin:"+8",coinCount:0,coinEffects:{1:"파괴 불가 코인"},refNote:"전투 호흡 참조",attachTo:"passive"}],
  "히스클리프|흑수 - 유 필두": [{name:"혈천하계무난도[血天下鷄舞亂刀]",sin:"분노",power:"5",coin:"+3",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 파열 횟수 2 증가",2:"파괴 불가 코인 [적중시] 화상 횟수 2 증가",3:"파괴 불가 코인 [적중시] 파열 2 부여",4:"파괴 불가 코인 [적중시] 화상 2 부여 [적중시] 자신에게 화상 이 20 이상 있거나, 자신의 현재 체력이 최대 체력의 50% 미만이면, 이 코인 재사용 (스킬당 1회) [적중시] 이 코인의 최종 피해량 20%만큼 모든 공격 대상에게 분노 피해를 줌 - 마지막에 사용하는 코인이면, 해당 피해량만큼 체력 회복"},refNote:"혈염난무 참조",attachTo:"passive"}],
  "히스클리프|중지 작은 형님": [{name:"전원, 처형이다!!",sin:"질투",power:"16",coin:"+10",coinCount:0,coinEffects:{1:"파괴 불가 코인 대상이 흐트러짐 상태면, 피해량 +20% [적중시] 출혈 5 부여 [적중시] 화상 5 부여 [적중시] 진동 5 부여 [적중시] 진동 폭발 . 진동 횟수 1 감소 [적중시] 이 코인 최종 피해량의 (질투 공명 수 × 7)%만큼 타격 피해 (최대 42%)"},refNote:"패시브 참조",attachTo:"passive"}],
  "히스클리프|거미집 엄지 제자": [{name:"세치오나투라 디 체르보",sin:"분노",power:"5",coin:"+3",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 화상 4 부여, 화상 횟수 3 증가",2:"파괴 불가 코인 [적중시] 진동 4 부여, 진동 횟수 3 증가",3:"파괴 불가 코인",4:"파괴 불가 코인 [코인 시작시] 완성되어가는 교본 1당, 이 코인의 위력 +1 (최대 3) [적중시] 진동 - 작열 로 진폭 변환 [적중시] 진동 폭발 3회. 대상의 진동 횟수 3 감소"},refNote:"스킬 3 참조",attachTo:"skill3"},{name:null,sin:"우울",power:"3",coin:"+10",coinCount:0,coinEffects:{1:"파괴 불가 코인"},refNote:"패시브 참조",attachTo:"passive"}],
  "이스마엘|가주 후보": [{name:"적격 - 시[始]",sin:"우울",power:"2",coin:"+2",coinCount:2,coinEffects:{2:"[적중시] 파열 1 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  "이스마엘|정사무소 대표": [{name:"코오쟌 [光斬]",sin:"질투",power:"4",coin:"+5",coinCount:1,coinEffects:{1:"[적중시] 자신의 ( 광【光】 위력 - 1)만큼 이 코인 재사용 (최대 4회) [적중시] 진동 횟수 1 증가 [적중시] 침잠 횟수 1 증가 [앞면 적중시] 방어 레벨 감소 1 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  "이스마엘|LCD 현장추리팀": [{name:"골단",sin:"오만",power:"5",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 호흡 3 얻음 [적중시] 참격 취약 1 부여 (턴당 1회)",2:"[적중시] 출혈 2 부여 [적중시] 다음 턴에 마비 1 부여"},refNote:"패시브 참조",attachTo:"passive"},{name:"상전 청린화",sin:"분노",power:"5",coin:"+3",coinCount:4,coinEffects:{1:"[적중시] 호흡 3 얻음 [크리티컬 적중 시] 묵 공방 - 예[銳] 2식 발도 / 추력:도깨비불 1 얻음",2:"[적중시] 출혈 1 부여 [크리티컬 적중 시] 묵 공방 - 예[銳] 2식 발도 / 추력:도깨비불 1 얻음",3:"[적중시] 출혈 1 부여 [크리티컬 적중 시] 묵 공방 - 예[銳] 2식 발도 / 추력:도깨비불 1 얻음",4:"자신의 묵 공방 - 예[銳] 2식 발도 / 추력:도깨비불 수치가 15를 초과했으면, 초과된 수치 1당, 크리티컬 피해량 +5% (최대 25%) [적중시] 출혈 1 부여 [크리티컬 적중 시] 자신의 신속 이 5 이상이면, 이 코인 재사용 (스킬당 1회)"},refNote:"패시브 참조",attachTo:"passive"},{name:"형세 읽기",sin:"우울",power:"4",coin:"+9",coinCount:0,coinEffects:{1:"파괴 불가 코인"},refNote:"원호 방어 참조",attachTo:"defense"}],
  "로쟈|흑운회 와카슈": [{name:"쾌청 베기",sin:"오만",power:"7",coin:"+18",coinCount:1,coinEffects:{1:"[크리티컬 적중 시] 출혈 10 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  ...
  "로쟈|로보토미 E.G.O::눈물로 벼려낸 검": [{name:"빛바랜 믿음",sin:"우울",power:"10",coin:"-4",coinCount:2,coinEffects:{1:"[적중시] 침잠 2 부여",2:"[적중시] 침잠 1 부여 [적중시] 자신의 깊은 눈물 2 얻음 - 꿰뚫는 검 2당 깊은 눈물 1 추가로 얻음 (최대 2)"},refNote:"패시브 참조",attachTo:"passive"},{name:"눈물로 벼려낸 검으로",sin:"질투",power:"16",coin:"-4",coinCount:3,coinEffects:{2:"[적중시] 침잠 3 부여",3:"[적중시] 침잠 2 부여, 침잠 횟수 2 증가 [적중시] 자신의 깊은 눈물 3 얻음 - 꿰뚫는 검 수치만큼 깊은 눈물 추가로 얻음 (최대 5)"},refNote:"패시브 참조",attachTo:"passive"},{name:"아르카나 티어 앤 피어스",sin:"오만",power:"20",coin:"-5",coinCount:3,coinEffects:{2:"[적중시] 침잠 횟수 4 증가",3:"[적중시] 침잠 5 부여 (스킬당 1회) [적중시] 이 코인에서 눈물 벼리기 를 소모하였다면, 코인 1회 재사용 (턴당 1회)"},refNote:"패시브 참조",attachTo:"passive"},{name:"닳아버린 긍지",sin:"우울",power:"12",coin:"-4",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 침잠 1 부여",2:"파괴 불가 코인 [적중시] 침잠 2 부여"},refNote:"패시브 참조",attachTo:"passive"}],
  ...
  "로쟈|거미집 엄지 아비": [{name:"세치오나투라 디 코닐리오",sin:"색욕",power:"4",coin:"+4",coinCount:2,coinEffects:{1:"[적중시] 화상 횟수 1 증가 [적중시] 진동 횟수 2 증가",2:"[적중시] 진동 폭발 . 진동 횟수 1 감소"},refNote:"패시브 참조",attachTo:"passive"},{name:"세치오나투라 디 체르보",sin:"나태",power:"4",coin:"+4",coinCount:3,coinEffects:{1:"[적중시] 호흡 5 얻음 [적중시] 화상 2 부여",2:"[적중시] 진동 2 부여, 진동 횟수 2 증가 [적중시] 진동 - 작열 로 진폭 변환",3:"[적중시] 진동 폭발 , 진동 횟수 1 감소 [적중시] 대상의 진동 이 10 이상이면, 진동 폭발 . 진동 횟수 1 감소"},refNote:"스킬 2 참조",attachTo:"skill2"},{name:"처분",sin:"분노",power:"5",coin:"+3",coinCount:0,coinEffects:{1:"파괴 불가 코인 [적중시] 화상 2 부여 [적중시] 진동 2 부여",2:"파괴 불가 코인 [적중시] 화상 2 부여 [적중시] 진동 2 부여",3:"파괴 불가 코인 [적중시] 화상 횟수 3 증가 [적중시] 진동 횟수 3 증가",4:"파괴 불가 코인 [적중시] 진동 - 작열 로 진폭 변환",5:"파괴 불가 코인 가속탄 최대 5까지 소모 이 코인 효과로 소모할 가속탄 1당, 피해량 +10% (최대 50%) [적중시] 진동 폭발 . 진동 횟수 1 감소 - 소모한 가속탄 만큼 효과 추가 발동 (최대 3회)"},refNote:"패시브 참조",attachTo:"passive"},{name:"예지",sin:"우울",power:"3",coin:"+7",coinCount:1,coinEffects:{},refNote:"패시브 참조",attachTo:"passive"}],
